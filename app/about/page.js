        ...
        <div className="container">
          <div className="row justify-content-between">
            <div
              ...
              data-aos-offset={50}
            >
              <span className="subtitle mb-35">Urban Adventure tourism
              </span>
            </div>
      ...
      <section className="about-feature-two bgc-black pt-100 pb-45 rel z-1">
        <div className="container">
          <div
            ...
            data-aos-offset={50}
          >
            <SectionTitle title={"How to Benefit Our Urban Adventure Tourism "} />
          </div>
          <div className="row">
            <div
            ...
            >
              <div className="feature-item style-two">
                ...
                <div className="content">
                  <h5>
                    <Link href="tour-list">Best Rate Guarantee</Link>
                  </h5>
            ...
            >
              <div className="feature-item style-two">
                ...
                <div className="content">
                  <h5>
                    <Link href="tour-list">Diverse Destinations</Link>
                  </h5>
                  <p>
                    Biking is the best Experience in Safari Desert
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="feature-item style-two">
                ...
                <div className="content">
                  <h5>
                    <Link href="tour-list">Fast Booking</Link>
                  </h5>
                  <p>Parks UAE is a thrilling outdoor activity</p>
                </div>
              </div>
            </div>
            <div
            ...
            >
              <div className="feature-item style-two">
                ...
                <div className="content">
                  <h5>
                    <Link href="tour-list">Best Travel Guide</Link>
                  </h5>
                  <p>Enjoy Safari Desert Activities , biking</p>
                </div>
              </div>
            </div>
          </div>
