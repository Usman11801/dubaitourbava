            ...
            >
              <div className="footer-widget footer-text">
                <div className="footer-logo mb-25">
                  <Link href="/">
                    <img src="assets/images/logos/logoo.png" alt="Logo" />
                  </Link>
                </div>
                <p>
                ...
                <ul className="list-style-three">
                  <li>
                    <Link  href={{
                          ...
                          query: { id: 1 },
                        }}>Morning Safari Desert</Link>
                  </li>
                  <li>
                    <Link href={{
                          pathname: '/top-tour-details',
                          query: { id: 2 },
                        }}>Abu Dhabi City Tour</Link>
                  </li>
                  <li>
                    <Link href={{
                          pathname: '/top-tour-details',
                          query: { id: 3 },
                        }}>Evening Desert Safari</Link>
                  </li>
                </ul>
              </div>
            </div>
            ...
            >
              <div className="footer-widget footer-contact">
                ...
                <ul className="list-style-one">
                  <li>
                    <i className="fal fa-map-marked-alt" /> Al zahraa techno center al rafa office 101 Dubai UAE
                  </li>
                  <li>
